...
const DailyLoanForm = ({
  ...
  return (
    <form
      ...
      className={`space-y-8 animate-in fade-in duration-500 ${isDarkMode ? "daily-loan-form-dark-mode" : ""}`}
    >
      <style jsx global>{`
        /* Scoped DailyLoanForm dark mode overrides. Shared by the Daily
           Loans view, edit, and add pages. Prefixed with
           .daily-loan-form-dark-mode so nothing here can affect any
           other page. */
        .daily-loan-form-dark-mode .bg-white {
          background-color: #1e293b !important;
        }
        .daily-loan-form-dark-mode .bg-slate-50,
        .daily-loan-form-dark-mode .bg-slate-100 {
          background-color: #334155 !important;
        }
        .daily-loan-form-dark-mode .bg-slate-100\/50 {
          background-color: rgba(51, 65, 85, 0.5) !important;
        }
        .daily-loan-form-dark-mode .bg-emerald-50 {
          background-color: rgba(16, 185, 129, 0.15) !important;
        }
        .daily-loan-form-dark-mode .text-slate-900 {
          color: #f1f5f9 !important;
        }
        .daily-loan-form-dark-mode .text-slate-700 {
          color: #e2e8f0 !important;
        }
        .daily-loan-form-dark-mode .text-slate-600 {
          color: #cbd5e1 !important;
        }
        .daily-loan-form-dark-mode .text-slate-500 {
          color: #94a3b8 !important;
        }
        .daily-loan-form-dark-mode .border-slate-100,
        .daily-loan-form-dark-mode .border-slate-200 {
          border-color: rgba(255, 255, 255, 0.08) !important;
        }
        .daily-loan-form-dark-mode input,
        .daily-loan-form-dark-mode select,
        .daily-loan-form-dark-mode textarea {
          color-scheme: dark;
        }
      `}</style>
      {/* Customer Info */}
