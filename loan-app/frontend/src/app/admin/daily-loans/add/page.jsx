...
const AddDailyLoanPage = () => {
  ...
  return (
    <AuthGuard>
      <style jsx global>{`
        .daily-loan-add-dark-mode {
          background-color: #0f172a;
        }
        .daily-loan-add-dark-mode .text-slate-900 {
          color: #f1f5f9 !important;
        }
        .daily-loan-add-dark-mode .text-slate-500 {
          color: #94a3b8 !important;
        }
      `}</style>
      <div className={`flex min-h-screen bg-[#F8FAFC] transition-colors duration-300 ${isDarkMode ? "daily-loan-add-dark-mode" : ""}`}>
        <Sidebar />
